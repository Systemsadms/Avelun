...
?>    
  <br>
   ...
   <button type="submit" name="cargar_articulos" class="btn btn-dark">Cargar</button>
...
if(isset($_POST['cargar_articulos'])){
                  $marca = $_POST['marca'];
                  ...
                  while ($reg)
                    ...
                    <div style='width:300px; background-color:none; display:inline-block; vertical-align: top; margin-right:20px; margin-bottom:30px; text-align:center;'>
                      ...
                      <form method='post' action='editarArticulo.php' style='display:inline-block;'>
                        <input type='hidden' name='id_articulo' value='".$reg[0]."'/>
