...
<div class="banner" style='background-image: url(img/creceProfesionalmente.jpg);'>
</div>
...
<!--Video 1-->
		...
		<iframe src="https://www.youtube.com/embed/jovdhvkdTEw" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen class="video"></iframe>			
			<a href='mentoras/judit-catala.php'><h6 style='margin-top:-50px'>Judit Catalá (05/08/2020)</h6></a>
			<p style='color:black;'> 
¿Quieres ser un emprendedor de éxito?
<br>
Estás en el canal de Judit Catalá, donde tus sueños empresariales se hacen realidad, y hoy te quiero enseñar las  reglas para ser un emprendedor de éxito, para ser un emprendedor del cambio. ¡No te lo pierdas!
			<br><br><br>		
			</p>
		</div>
<!--Video 2-->
		<div class='marcoVideostop'>
		<iframe width="560" height="315" src="https://www.youtube.com/embed/s5Qac9gnFS0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen class="video"></iframe>		
			<a href='mentoras/maider-tomasena.php'><h6 style='margin-top:-50px'>Maïder Tomasena (02/08/2020)</h6></a>
			<p style='color:black;' >
			Hoy vamos a profundizar cómo encontrar tu tono de voz ideal y en la importancia que tiene y que define tu tono de voz de cara a tu audiencia. Quiero que descubras conmigo cómo influye el tono de voz en los textos. Recuerda: encuentra tu tono irresistible para tener éxito como marca y lograr que tu audiencia te identifique			 
			<br><br><br>
			</p>
		</div>
...
<!--Video 3-->
		...
		<iframe width="560" height="315" src="https://www.youtube.com/embed/aYEfi9l8AMQ" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
			<a href='mentoras/lucia-jimenez.php'><h6 style='margin-top:-50px'>Lucía Jiménez Vida (29/07/2020)</h6></a>
			<p style='color:black; margin-bottom: 50px;' >
Termina el día, miras tu lista de tareas y... horror, te queda TANTO por hacer. Tu energía está al límite y dudas entre seguir trabajando hasta las tantas o cerrarlo todo. ¿Qué hacer? Te cuento cómo lidiar con la frustración por las tareas pendientes en este vídeo.
