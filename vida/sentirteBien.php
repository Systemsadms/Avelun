...
<div class="banner" style='background-image: url(img/sentirteBien.jpg);'>
</div>
...
<?php
	...
	$path = 'img'; /*link de imagen */
	 include ("mentoras-sentirteBien.php");
?>
...
<!--Video 1-->
		...
		<iframe width="560" height="315" src="https://www.youtube.com/embed/WamU36hXiNw" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen class="video"></iframe>			
			<a href='mentoras/xuan-lan.php'><h6 style='margin-top:-50px'>Xuan Lan</h6></a>
			<p style='color:black;'> 
			Tu Primera Clase de Yoga (Nivel principiante),
			mi objetivo es transmitir que el yoga es mucho más que una serie de ejercicios físicos; es un estilo de vida.
			<br><br><br>		
			</p>
		</div>
<!--Video 2-->
		<div class='marcoVideostop'>
		<iframe width="560" height="315" src="https://www.youtube.com/embed/wNhwty4GeK0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen class="video">></iframe>
			<a href='mentoras/xuan-lan.php'><h6 style='margin-top:-50px'>Xuan Lan</h6></a>
			<p style='color:black;' >
			7 Consejos para Tu Primera Clase de Yoga<br>
			En las clases de yoga que imparto aprenderás todas las posiciones de yoga que ansías conocer, así como sus modalidades, ejercicios de relajación y meditación, consejos... ¡Todo lo necesario para practicar yoga en casa.		 
			<br><br><br>
			</p>
		</div>
...
<!--Video 5-->
	<div class='marcoVideos'>
		<iframe width="560" height="315" src="https://www.youtube.com/embed/PL9tEzDUZrw" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
			<a href='mentoras/xuan-lan.php'><h6 style='margin-top:-50px'>Xuan Lan</h6></a>
			<p style='color:black; margin-bottom: 50px;' >
			Trucos sobre cómo controlar la ansiedad puntual
			</p>
		</div>
<!--Video 6-->
		<div class='marcoVideos'>
		<iframe width="560" height="315" src="https://www.youtube.com/embed/Q6O_fOaxR3c" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
			<a href='mentoras/valentina-brand.php'><h6 style='margin-top:-50px'>Valentina Brand</h6></a>
			<p style='color:black; margin-bottom: 50px;' >
			Meditación para soltar la tensión			</p>

		</div>

<!--Video 3-->
		<div class='marcoVideos'>
		<iframe width="560" height="315" src="https://www.youtube.com/embed/KYwdf0G0lKE" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
			<a href='mentoras/xuan-lan.php'><h6 style='margin-top:-50px'>Xuan Lan</h6></a>
			<p style='color:black; margin-bottom: 50px;' >
			Consejo Vida saludable: Mi dieta equilibrada		
			</p>
		</div>
<!--Video 4-->	
		<div class='marcoVideos'>
		<iframe width="560" height="315" src="https://www.youtube.com/embed/qvuELlIG1Fw" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
			<a href='mentoras/xuan-lan.php'><h6 style='margin-top:-50px'>Xuan Lan</h6></a>
			<p style='color:black; margin-bottom: 50px;' >
			Yoga para mejorar el Sistema Inmunitario (30 min) 
</p>
		</div>
