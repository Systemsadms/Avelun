...
.fotoPerfil{
	background-image:url("../mentoras/fotos/beatriz.jpg");
...
<div class='bioPerfil'>
	<h6>Beatriz Estrada</h6>
	<p>
		Vistete con Beatriz, Nuevos Look, combinazaciones, ropa y estilos  para todas las temporadas
		conoce lo nuevo en las tiendas y marcas de tu preferencia con las recomendaciones 
		selectas que Beatriz tiene para ti.

		<div style='text-align:center; margin-top:10px;'>
			<button type="button" class="btn btn-dark">Habla Personalmente con Beatriz</button>
		</div>
	</p>
</div>
...
<div style="text-align: center; max-width: 100%;">
	...
	<iframe width="560" height="315" src="https://www.youtube.com/embed/sfHdcdX5mws" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				<div style='text-align:justify;'>
				<h6 style='margin-top:-50px'>¡HAUL SHEIN ENORME! Mucha ROPA de NUEVA COLECCIÓN | Bstyle</h6>
				<br>
	...
	<iframe width="560" height="315" src="https://www.youtube.com/embed/kUhPar1bt9M" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				<div style='text-align:justify;'>
				<h6 style='margin-top:-50px'>¡NOVEDADES PULL&BEAR! TODA la NUEVA COLECCIÓN + GOA organics | Bstyle</h6>
				<!--<p style='color:black; margin-bottom:40px;'>MIWOS! No se les olvide checar mi Instagram para ver adelantos de los videos de youtube y pues cosas buena onda</p>-->
				<br>
				</div>
	<iframe width="560" height="315" src="https://www.youtube.com/embed/jax2egT4XdA" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				<div style='text-align:justify;'>
				<h6 style='margin-top:-50px'>¡NOVEDADES ZARA! Ropa PRECIOSA de NUEVA COLECCIÓN | Bstyle</h6>
				<!--<p style='color:black; margin-bottom:40px;'>MIWOS! No se les olvide checar mi Instagram para ver adelantos de los videos de youtube y pues cosas buena onda</p>-->
				<br>	
				</div>
	<iframe width="560" height="315" src="https://www.youtube.com/embed/w7A21XW7GQs" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				<div style='text-align:justify;'>
				<h6 style='margin-top:-50px'>¡NOVEDADES BERSHKA! Ropa de NUEVA COLECCIÓN + Easehold | Bstyle</h6>
				<!--<p style='color:black; margin-bottom:40px;'>MIWOS! No se les olvide checar mi Instagram para ver adelantos de los videos de youtube y pues cosas buena onda</p>-->
				<br>
				</div>
	<iframe width="560" height="315" src="https://www.youtube.com/embed/53E_AOO1mbc" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				<div style='text-align:justify;'>
				<h6 style='margin-top:-50px'>¡NOVEDADES STRADIVARIUS! Ropa INCREÍBLE de NUEVA COLECCIÓN</h6>
				<!--<p style='color:black; margin-bottom:40px;'>MIWOS! No se les olvide checar mi Instagram para ver adelantos de los videos de youtube y pues cosas buena onda</p>-->
				<br>
				</div>


				<a href='https://www.youtube.com/user/alwaysBet9' target='_blank'><h5>Ver mas videos de Beatriz Estrada</h5></a>
	...
	<aside class="posts" id="posts" >
		<p>Pronto publicaremos los posts mas recientes de Beatriz Estrada</p>
		<!--
		<?php
