...
.fotoPerfil{
	background-image:url("../mentoras/fotos/estela.jpg");
...
<div class='bioPerfil'>
	<h6>Estela David Naula</h6>
	<p>
	Al crecer en una zona rural de Mozambique, Estela Naula creó una escuela de tutoría para brindar 
	habilidades básicas de aritmética y alfabetización a su comunidad. Este acto cambió la vida de Estela 
	y la llevó a la Academia de Liderazgo Africano, donde continuó su trayectoria de liderazgo.
	<br><br>
	Aprende Ingles y Portuguez en Español  y entiende como estudiar para construir el futuro.

		
		
		<div style='text-align:center; margin-top:10px;'>
			<button type="button" class="btn btn-dark">Habla Personalmente con Estela</button>
		</div>
	</p>
</div>
...
<div style='background-color:none; margin-top:50px; margin-bottom:30px;'>
	<div class="tabsPostVideo" onclick='vervi()'>SUS PODCAST</div>
...
<div style="text-align: center; max-width: 100%;">
	...
	<div class="videos" id="videos">
				...
				<a href='https://podcasts.google.com/feed/aHR0cHM6Ly9hbmNob3IuZm0vcy8yM2Q0NjI3OC9wb2RjYXN0L3Jzcw=='>
					<div style='
						width:485px;
						height: 250px;
				...
				<h6 style='margin-top:10px'>Portuges and English Learning <b>EPISODE 1</b></h6>
				<p style='color:black; margin-bottom:40px;' >En este episodio Estela te comineza con un introduccion para que comiences a estudiar palabras en Ingles, Portugues y tips para aprender escuchando musica    </p>
				</div>
				...
				<div style='text-align:justify;'>
				<h6 style='margin-top:10px'>English Learning <b>EPISODE 2</b></h6>
				<p style='color:black; margin-bottom:40px;' >NBM-Dicas para aprender Inglês e declamação de um poema com Ruben Zacarias</p>
				</div>
				...
				<div style='text-align:justify;'>
				<h6 style='margin-top:10px'>Spanish Learning <b>EPISODE 3</b></h6>
				<p style='color:black; margin-bottom:40px;' >NBM-Best tips to learn Spanish,
					Fam! Find the best tips to learn (any language) Spanish; </p>
				</div>
...
<!--			<a href='https://www.youtube.com/user/ideasempresa' target='_blank'><h5>Ver mas videos de Judit Catala</h5></a>-->
	...
	<aside class="posts" id="posts" >
		<p>Pronto publicaremos los posts mas recientes de Estela David Naula</p>
		<!--
		<?php
