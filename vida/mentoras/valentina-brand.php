...
.fotoPerfil{
	background-image:url("../mentoras/fotos/valentina.jpg");
...
<div class='bioPerfil'>
	<h6>La Tienda de Valentina</h6>
	<p>
	En la tienda de valentina encontraras las prendas que buscas para lucir como te gusta.
				Para todas  las temporadas y gustos. Valentina y su equipo te muestran todo lo que puedes
				encontrar en la Tienda

		<div style='text-align:center; margin-top:10px;'>
			<button type="button" class="btn btn-dark">Habla Personalmente con Valentina</button>
		</div>
	</p>
</div>
...
<div style="text-align: center; max-width: 100%;">
	...
	<iframe width="560" height="315" src="https://www.youtube.com/embed/CxEGMRC5Whw" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				<div style='text-align:justify;'>
				<h6 style='margin-top:-50px'>Directo: VALENTiNA loves CURVY: El COLOR COMODÍN</h6>
				<br>
	...
	<iframe width="560" height="315" src="https://www.youtube.com/embed/MYUQeBDCuq0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				<div style='text-align:justify;'>
				<h6 style='margin-top:-50px'>Directo: VALENTiNA NOCHE</h6>
				<!--<p style='color:black; margin-bottom:40px;'>MIWOS! No se les olvide checar mi Instagram para ver adelantos de los videos de youtube y pues cosas buena onda</p>-->
				<br>
				</div>
	<iframe width="560" height="315" src="https://www.youtube.com/embed/zEekuXfYe08" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				<div style='text-align:justify;'>
				<h6 style='margin-top:-50px'>Directo: Café con VALENTiNA - ¡¡REPOSiCiONES + OFERTAS EXPRESS!!</h6>
				<!--<p style='color:black; margin-bottom:40px;'>MIWOS! No se les olvide checar mi Instagram para ver adelantos de los videos de youtube y pues cosas buena onda</p>-->
				<br>	
				</div>
	<iframe width="560" height="315" src="https://www.youtube.com/embed/-BG-aydrkYg" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				<div style='text-align:justify;'>
				<h6 style='margin-top:-50px'>Directo: VALENTiNA Personal Shopper : RETO para DIRECTOS</h6>
				<!--<p style='color:black; margin-bottom:40px;'>MIWOS! No se les olvide checar mi Instagram para ver adelantos de los videos de youtube y pues cosas buena onda</p>-->
				<br>
				</div>
	<iframe width="560" height="315" src="https://www.youtube.com/embed/nDDCEpWrqw8" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				<div style='text-align:justify;'>
				<h6 style='margin-top:-50px'>Directo: VALENTiNA loves CURVY: Las BLAZERS del VERANO</h6>
				<!--<p style='color:black; margin-bottom:40px;'>MIWOS! No se les olvide checar mi Instagram para ver adelantos de los videos de youtube y pues cosas buena onda</p>-->
				<br>
				</div>


				<a href='https://www.youtube.com/c/ValentinaBrand/featured' target='_blank'><h5>Ver mas videos de Valentina Brand</h5></a>
	...
	<aside class="posts" id="posts" >
		<p>Pronto publicaremos los posts mas recientes de Valentina Brand</p>
		<!--
		<?php
