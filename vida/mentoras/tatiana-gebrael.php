...
.fotoPerfil{
	background-image:url("../mentoras/fotos/tati.png");
...
<div class='bioPerfil'>
	<h6>Tatiana Gebrael</h6>
	<p>
	Experta en el mejoramiento de la salud visual con mas de veinticinco mil alumnos en todo 
	el mundo, Tatiana te muestra que puedes hacer para tener una vista de aguila con ejercicios diarios
	que mejoraran tu vision y tu vida.



		<div style='text-align:center; margin-top:10px;'>
			<button type="button" class="btn btn-dark">Habla Personalmente con Tatiana</button>
		</div>
	</p>
</div>
...
<div style="text-align: center; max-width: 100%;">
	...
	<iframe width="560" height="315" src="https://www.youtube.com/embed/-HHDA7RlUZw" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				<div style='text-align:justify;'>
				<h6 style='margin-top:-50px'>CLASE 1 EN EL AIRE PARA LA JORNADA INTENSIVA DE MEJORA VISUAL</h6>
				<p style='color:black; margin-bottom:40px;' >🔴 ES HOY Empieza la Jornada Intensiva de Mejora Visual  🔴
				<br>
				Mis Alumnos están viendo mejor y cambiando sus hábitos visuales consistentemente.😊🌼
				</p>
				</div>
<!--
...
Espero que puedas repasar conceptos del curso de 2019 que son correlativos con este curso.</p>
	...
	-->
				<a href='https://www.youtube.com/channel/UCWoDpoAzrO_RguuBa4A63wg' target='_blank'><h5>Ver mas videos Tatiana Gebrael</h5></a>
	...
	<aside class="posts" id="posts" >
		<p>Pronto publicaremos los posts mas recientes de Tatiana Gebrael</p>
		<!--
		<?php
