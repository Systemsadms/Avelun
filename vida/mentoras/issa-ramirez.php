...
.fotoPerfil{
	background-image:url("../mentoras/fotos/issa.jpg");
...
<div class='bioPerfil'>
	<h6>Issa Ramirez</h6>
	<p>
	Porque hay tantos olores como sbores, Issa te cuenta todo  sobre las presentaciones y cada edicion de los 
	perfumes mas destacados del mercado y no tan destacados. Con descripciones detalladas de cada fragancia 
	conoceras todo lo que necesitas saber de cada perfume. 

		<div style='text-align:center; margin-top:10px;'>
			<button type="button" class="btn btn-dark">Habla Personalmente con Issa</button>
		</div>
	</p>
</div>
...
<div style="text-align: center; max-width: 100%;">
	...
	<iframe width="560" height="315" src="https://www.youtube.com/embed/ldkCjXIQ-7Q" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				<div style='text-align:justify;'>
				<h6 style='margin-top:-50px'>Directo Perfumado Con Isa Ramirez</h6>
				<br>
	...
	<iframe width="560" height="315" src="https://www.youtube.com/embed/bvvx7gVO5hk" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				<div style='text-align:justify;'>
				<h6 style='margin-top:-50px'>UNBOXING PERFUMERIA PRIMOR - PRIMERAS IMPRESIONES DE PERFUMES HOLLISTER DE MUJER Y HOMBRE</h6>
				<!--<p style='color:black; margin-bottom:40px;'>MIWOS! No se les olvide checar mi Instagram para ver adelantos de los videos de youtube y pues cosas buena onda</p>-->
				<br>
				</div>
	<iframe width="560" height="315" src="https://www.youtube.com/embed/l0kD1tLlKZY" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				<div style='text-align:justify;'>
				<h6 style='margin-top:-50px'>UNBOXING DE MINIATURAS DE PERFUME DE COLECCIÓN Y MUESTRAS</h6>
				<!--<p style='color:black; margin-bottom:40px;'>MIWOS! No se les olvide checar mi Instagram para ver adelantos de los videos de youtube y pues cosas buena onda</p>-->
				<br>	
				</div>
	<iframe width="560" height="315" src="https://www.youtube.com/embed/OljEwO5nPUU" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				<div style='text-align:justify;'>
				<h6 style='margin-top:-50px'>YSATIS GIVENCHY reseña de perfume</h6>
				<!--<p style='color:black; margin-bottom:40px;'>MIWOS! No se les olvide checar mi Instagram para ver adelantos de los videos de youtube y pues cosas buena onda</p>-->
				<br>
				</div>
	<iframe width="560" height="315" src="https://www.youtube.com/embed/GFwQeMkKGc8" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				<div style='text-align:justify;'>
				<h6 style='margin-top:-50px'>IRRESISTIBLE GIVENCHY reseña de perfume ¡NUEVO 2020!</h6>
				<!--<p style='color:black; margin-bottom:40px;'>MIWOS! No se les olvide checar mi Instagram para ver adelantos de los videos de youtube y pues cosas buena onda</p>-->
				<br>
				</div>


				<a href='https://www.youtube.com/channel/UCTK5uOlYTFHTSXp4nkuP-UQ' target='_blank'><h5>Ver mas videos de Issa Ramirez</h5></a>
	...
	<aside class="posts" id="posts" >
		<p>Pronto publicaremos los posts mas recientes de Issa Ramirez</p>
		<!--
		<?php
