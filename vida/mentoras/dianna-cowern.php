...
.fotoPerfil{
	background-image:url("../mentoras/fotos/dianna.jpg");
...
<div class='bioPerfil'>
	<h6>Dianna Cowern</h6>
	<p>
	 Graduada en Fisica en el Instituto Tecnologico de Massachsetts, Divulgadora Cientifica y Presentadora del canal
	 Phyisics Girl, Dianna 	 hace a la ciencia más accesible para las chicas, Empezó a hacer vídeos mientras trabajaba en General Electric.
	  Ganó un premio al mejor vídeo del Centro de Comunicación Científica de Alan Alda de la Universidad de 
	  Stony Brook

		
		
		<div style='text-align:center; margin-top:10px;'>
			<button type="button" class="btn btn-dark">Habla Personalmente con Dianna</button>
		</div>
	</p>
</div>
...
<div style="text-align: center; max-width: 100%;">
	...
	<div class="videos" id="videos">
		...
		<iframe width="560" height="315" src="https://www.youtube.com/embed/GOuZkYDQjpc" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				<div style='text-align:justify;'>
				<h6 style='margin-top:-50px'>Dianna's Intro Physics Class: Trailer - Physics 101, AP Physics 1 Review with Physics Girl</h6>
				<p style='color:black; margin-bottom:40px;' > Never taken physics before? Want to learn the basics of physics? Need an AP Physics 1 review before the exam? This course is for you! </p>
				</div>

		<iframe width="560" height="315" src="https://www.youtube.com/embed/O97lI8FVEas" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				<div style='text-align:justify;'>
				<h6 style='margin-top:-50px'>1D Motion & Kinematics - Physics 101 aka AP Physics 1 Review with Dianna Cowern</h6>
				<p style='color:black; margin-bottom:40px;'> Never taken physics before? Want to learn the basics of physics? Need an AP Physics 1 review before the exam? This course is for you!
				</p>
				</div>
		...
		<iframe width="560" height="315" src="https://www.youtube.com/embed/dGso5pberjI" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
			<div style='text-align:justify;'>
				<h6 style='margin-top:-50px'>YO FISICA</h6>
				<p style='color:black; margin-bottom:40px;'>  </p>
				</div>

				<a href='https://www.youtube.com/c/physicsgirl/featured' target='_blank'><h5>Ver mas videos de Dianna Cowern</h5></a>
	...
	<aside class="posts" id="posts" >
		<p>Pronto publicaremos los posts mas recientes de Dianna Cowern</p>
		<!--
		<?php
