...
<div class='bioPerfil'>
	<h6>Maïder Tomasena</h6>
	<p>
	Copywriter profesional, fundadora de la primera escuela de Copywriter en español, Maider
	...
	te enseñara, no te pierdas sus cursos si quieres ser una profesional del copyrighther.
...
<div style="text-align: center; max-width: 100%;">
	...
	<iframe width="560" height="315" src="https://www.youtube.com/embed/8O8NNd3Kqe8" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				...
				<h6 style='margin-top:-50px'>Cómo ser CREATIVO Escribiendo</h6>
				<p style='color:black; margin-bottom:40px;' > ¿Te has preguntado alguna vez el secreto para saber cómo ser creativo escribiendo? Hoy quiero contarte hoy que 5 ejercicios que te ayudarán a descubrir cómo trabajar la creatividad y a crear tu nevera de ideas y recursos para cuando lleguen momentos de bloqueo. </p>
				</div>
	...
	<iframe width="560" height="315" src="https://www.youtube.com/embed/ftJ9jD0arGo" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				<div style='text-align:justify;'>
				<h6 style='margin-top:-50px'>Cómo Redactar Copys para Facebook Ads ✍🏼</h6>
				<p style='color:black; margin-bottom:40px;'> Hoy estoy aquí para ayudarte a que a saber cómo redactar copys para Facebook Ads y a que le pierdas el miedo a escribir con límite de palabras. Tu trabajo en el proceso de saber cómo redactar copys para anuncios será escribir siempre pensando en cuál es el punto en el que se encuentran respecto a tu marca. </p>
				</div>
	<iframe width="560" height="315" src="https://www.youtube.com/embed/GqxXiccVd8I" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				...
				<p style='color:black; margin-bottom:40px;'> En el vídeo de hoy quiero hablarte de los Pros y Contras de los puntos suspensivos en tus textos para que puedas mejorar tu escritura persuasiva en correos electrónicos, mensajes de redes sociales o sitio web.</p>
				</div>
	<iframe width="560" height="315" src="https://www.youtube.com/embed/Xgs_qwh_g1Q" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				<div style='text-align:justify;'>
				<h6 style='margin-top:-50px'>Cómo Redactar una Carta de Ventas 📝💶</h6>
				<p style='color:black; margin-bottom:40px;'> Qué tiene una buena página de ventas para que empuje a un cliente a dar el paso y que compre ahora? ¿Qué estructura debes seguir una carta de ventas para organizar la información y ser más persuasiva? ¿Cómo de larga debe ser una página de ventas para que funcione?</p>
				</div>
	<iframe width="560" height="315" src="https://www.youtube.com/embed/Vx16DjrOjnc" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
				<div style='text-align:justify;'>
				<h6 style='margin-top:-50px'>Masterclass de copywriting en páginas de venta</h6>
				<p style='color:black; margin-bottom:40px;'> LA FASE FINAL - 30 días por delante para trabajar el copywriting de tu negocio. </p>
				</div>

				<a href='https://www.youtube.com/c/Ma%C3%AFderTomasenaCopywritingWeb' target='_blank'><h5>Ver mas videos de Maïder Tomasena</h5></a>
				<div style='text-align:center; margin-top:10px; margin-bottom:50px;'>
					<button type="button" class="btn btn-dark">Habla Personalmente con Maïder</button>
				</div>
	</div>         <!-- FIN DE CONTENEDOR VIDEOS-->


	<aside class="posts" id="posts" >
		<p>Pronto publicaremos los posts mas recientes de Maïder Tomasena</p>
		<!--
		<?php
