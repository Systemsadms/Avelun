...
<div class="banner" style='background-image: url(img/verteBien.jpg);'>
</div>
...
<!--Video 1-->
	...
	<iframe width="560" height="315" src="https://www.youtube.com/embed/HMTLGwWfd9A" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen class="video"></iframe>
			<a href='mentoras/anna-sarelly.php'><h6 style='margin-top:-50px'>Anna Sarelly</h6></a>
			<p style='color:black;'> 
			3 maquillajes de VERANO usando REVLON + outfit | Anna Sarelly |
			No se les olvide checar su Instagram para ver adelantos de los videos de youtube y pues cosas buena onda,
			<br><br><br>		
			</p>
		</div>
<!--Video 2-->
		<div class='marcoVideostop'>
<iframe width="560" height="315" src="https://www.youtube.com/embed/BHNPz_MwOm8" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen class="video"></iframe>
			<a href='mentoras/issa-ramirez.php'><h6 style='margin-top:-50px'>Issa Ramirez</h6></a>
			<p style='color:black;' >
			PERFUMES FOTOGÉNICOS PARA INSTAGRAM - COLABORACIÓN CON @Maria Carattini - consejos para tus fotos, Visita nuestro instagram 			 
			<br><br><br>
			</p>
		</div>
...
<!--Video 3-->
		...
		<iframe width="560" height="315" src="https://www.youtube.com/embed/oKAITTRveII" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
			<a href='mentoras/beatriz-estrada.php'><h6 style='margin-top:-50px'>Beatriz Estrada</h6></a>
			<p style='color:black; margin-bottom: 50px;' >
			¡Hola a tod@s! En el vídeo de hoy os venís conmigo a la nueva tienda PRIMARK de Plaça Catalunya a ver todas las NOVEDADES de este VERANO 2020 y un haul.  ¡Espero que os guste! 
		
			</p>
		</div>
<!--Video 4-->	
		<div class='marcoVideos'>
		<iframe width="560" height="315" src="https://www.youtube.com/embed/ZpIHQ62FeY0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
			<a href='mentoras/beatriz-estrada.php'><h6 style='margin-top:-50px'>Beatriz Estrada</h6></a>
			<p style='color:black; margin-bottom: 50px;' >
			¡Hola a tod@s! En el vídeo de hoy os traigo un HAUL ENORME de ROPA de SHEIN, ZARA, BERSHKA, H&M para este VERANO ¡Espero que os guste! 
</p>
		</div>

<!--Video 5-->
		<div class='marcoVideos'>
		<iframe width="560" height="315" src="https://www.youtube.com/embed/k64Uv23s0I8" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
			<a href='mentoras/valentina-brand.php'><h6 style='margin-top:-50px'>Valentina Brand</h6></a>
			<p style='color:black; margin-bottom: 50px;' >
			Bienvenidas a nuestro programa número 57 de Personal Shopper de Valentina. 
			<br>
			El verde tiene fama de ser un color difícil de combinar. ¿Será verdad? En este vídeo os damos consejos sobre cómo combinar ropa de color verde y conseguir unos outfits estupendos y acordes a las últimas tendencias. Desde pantalones a faldas pasando por cualquier otra prenda en tono verde.		
			</p>
		</div>
<!--Video 6-->
		<div class='marcoVideos'>
		<iframe width="560" height="315" src="https://www.youtube.com/embed/udIZtQ9D-4M" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
			<a href='mentoras/valentina-brand.php'><h6 style='margin-top:-50px'>Valentina Brand</h6></a>
			<p style='color:black; margin-bottom: 50px;' >
			Directos con valentina, mira las prendas que van contigo, y conoce las creaciones y novedades de La Tienda de Valentina
			</p>
